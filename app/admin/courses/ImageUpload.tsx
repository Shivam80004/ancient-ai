...
/** Uploads an image to the public `course-thumbnails` bucket and returns its public URL. */
    ...
    return (
        <div>
            ...
            >
                ...
                <span className="truncate">{uploading ? "Uploading…" : done ? "Uploaded ✓" : label}</span>
